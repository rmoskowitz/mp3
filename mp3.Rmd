...
1. **Forests:**
Campsites must be located in a forest unlike the forest of the other two campsites. The existing campsites are located in an Old Field White Pine Forest and a Sugar Maple Forest, which can be found by clicking on the vegetation near these popups on the map below. We chose to place the campsites within an Active Pasture and Hayfield and the Hemlock Northern Hardwoods Forest instead.
...
The two campsites we proposed are located in new vegetation types (Active Pasture and Hayfield and the Hemlock Northern Hardwoods Forest), are in relatively flat areas, within 200' from a water source, and outside of the buffers around the challenge course elements and research stations. Click on the popups to see the existing campsites and our recommendation sites. 
