...
res_challenge_union <- st_union(challenge_buffer, research_buffer)

plot(res_challenge_union)
```
...
#adding the buffer: union of research and challenge course
  addPolygons(data = res_challenge_union, fill = TRUE, fillOpacity = 0.025, color = "red", stroke = FALSE) %>%
