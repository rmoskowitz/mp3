...
--> thoughts about a 3rd map (displayed first, that JUST shows vegetation type? with a color palette like == wetland_pal <- colorNumeric("viridis", 
                  macleish_layers[["wetlands"]]$SHAPE_AREA) but obviously not for wetlands, for forests??)
...
#adding the buffer: union of research and challenge course
  ...
  addPolygons(data = parking_buffer, fill = TRUE, color = "brown", stroke = FALSE)
```
